...
> **Sorting Hat, 통칭 그리핀도르 모자는 개인-환경 적합성(Person-Environment Fit) 이론을 기반으로 개인과 조직·직무 간의 적합성을 분석하는 HR Analytics 프로젝트입니다**
...
어떤 조직원과 한 팀이 되었을 때 최대 업무효율 및 직무 만족도 · 적합도가 최상이 되는지를 분석하는 모델입니다.
